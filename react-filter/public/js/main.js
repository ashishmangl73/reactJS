...
var List = React.createClass({
  ...
  render: function () {
    var ListItems = function (text) {
      return React.createElement(ListItem, { key: text, text: text });
    };
    return React.createElement(
      'ul',
      null,
      this.props.items.map(ListItems)
    );
  }
});
module.exports = List;

},{"./ListItem":167,"react":165}],167:[function(require,module,exports){
var React = require('react');
...
},{"./List.js":166,"react":165}],169:[function(require,module,exports){
var React = require('react');
var ReactDOM = require('react-dom');
var Counter = require('./components/ListManager.js');

ReactDOM.render(React.createElement(Counter, { title: 'Filter List' }), document.getElementById("ingredients"));

},{"./components/ListManager.js":168,"react":165,"react-dom":29}]},{},[169]);
