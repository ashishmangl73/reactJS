  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('input', { value: this.state.newTextItem, onChange: this.onChange }),
        React.createElement(
          'button',
          null,
          'Add'
...
ReactDOM.render(React.createElement(ListManager, { title: 'list' }), document.getElementById("ingredients"));
